...
int frecklesSolver(vii adjList)
{
	...
	//This block here is used to organize nodes in an ascending order fashion where I won't get repeats of pairs. 
	//I'm not sure if this is an odd way of doing it, but it sort of looks like a "rainbow" when I drew it by hand...
